...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head style="font-family: Helvetica, Arial, sans-serif;">
		...
		<title style="font-family: Helvetica, Arial, sans-serif;"><?= getStoreSettings('name') ?> </title>
						...
						<tbody>
							...
							<td width="100%" height="80" valign="top" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: center; vertical-align: middle;">
								...
								<table cellpadding="0" cellspacing="0" width="600" class="w320" style="border-collapse: collapse !important; font-family: Helvetica, Arial, sans-serif;">
									<tbody>
									<tr style="font-family: Helvetica, Arial, sans-serif;">
										<td class="mobile-header-padding-left" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding-left: 10px; text-align: center; vertical-align: middle; width: 290px;">
										<h1 style="color: #ffffff; padding-top: 12px; font-family: Helvetica, Arial, sans-serif;"><img class="lw-logo-img" src="https://queromeudaddy.com.br/imgs/logotipo-quero-p.png" alt="Quero Meu Daddy"></h1>
										</td>										
									</tr>
									</tbody>
								</table>
					...
					<center style="font-family: Helvetica, Arial, sans-serif;">
						...
						<tbody>
							...
							<td style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 25px 0 25px; text-align: center;">
								<strong style="font-family: Helvetica, Arial, sans-serif;">Quero Meu Daddy</strong><br style="font-family: Helvetica, Arial, sans-serif;"> 
							</tr>
						</tbody>
						</table>
					</center>
