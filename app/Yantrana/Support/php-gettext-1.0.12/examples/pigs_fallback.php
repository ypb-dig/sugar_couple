...
if (!locale_emulation()) {
    echo "<p>locale '$locale' is supported by your system, using native gettext implementation.</p>\n";
} else {
    echo "<p>locale '$locale' is <strong>not</strong> supported on your system, using custom gettext implementation.</p>\n";
}
?>
